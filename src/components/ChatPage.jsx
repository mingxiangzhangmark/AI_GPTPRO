...
//     const newChat = {
//         id: uuidv4(),
//         displayId: `${new Date().toLocaleDateString('en-GB')}
...
//         setInputValue('');
//     }else {
//         // Add new message to the current messages array
//         const updatedMessages = [...messages, newMessage];
//         setMessages(updatedMessages); // Update messages state
//         localStorage.setItem(activeChat, JSON.stringify(updatedMessages)); // Update local storage
//         setInputValue(''); // Clear input

//         // Update the chats with the new messages for the first chat (or active chat)
//         const updatedChats = chats.map((chat) => {
//         if (chat.id === activeChat) {
//             return {
//             ...chat,
//             messages: updatedMessages, // Update messages in the chat object
//             };
//         }
//         return chat;
//         });
//         setChats(updatedChats); // Update chats state
...
//       {/* Chat List */}
//       <div className="w-1/4 h-full bg-dark_black px-4 flex flex-col space-y-3">
//         <div className="w-full flex items-center justify-between pl-2 py-4 text-slate-300">
//           <h2 className="text-xl font-bold uppercase pt-2">Chat List</h2>
//           <i className="bx bx-x-circle text-2xl pt-2 pr-2 hover:text-slate-100 cursor-pointer "
...
//           >
//             <h4 className="text-lg font-light text-gray-300 flex pl-1">Chat  
//                 <p className="text-sm flex pt-1 pl-4">
//                    { chat.displayId}
//                 </p>
//             </h4>
...
//           <h3 className="text-xl font-extrabold text-slate-300 font-exo uppercase">
//             Chat with GPT-PRO
//           </h3>
